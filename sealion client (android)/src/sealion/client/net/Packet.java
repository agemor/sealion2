...
public class Packet {
	...
	public static enum Type {
		SIGNIN_SUCCESSFUL, SIGNIN_FAILED, GREETINGS, ERROR_MAXIMUM_CONNECTION_EXCEEDED, ERROR_DUPLICATE_CONNECTION
	}
	...
	static {
		...
		packets.put(Type.ERROR_MAXIMUM_CONNECTION_EXCEEDED, new Packet(Header.ERROR, "ERROR: MXCOEX"));
		packets.put(Type.ERROR_DUPLICATE_CONNECTION, new Packet(Header.ERROR, "ERROR: DUCO"));
	}
