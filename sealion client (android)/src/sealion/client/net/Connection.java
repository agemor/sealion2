...
public class Connection {
	 ...
	 * 이벤트 리스너 목록
	 */
	public static List<SigninEvent> signinEventListeners;
	public static List<SignupEvent> signupEventListeners;
	public static List<ErrorEvent> errorEventListeners;
	public static List<UserEvent> userEventListeners;
	public static List<NoticeEvent> noticeEventListeners;
